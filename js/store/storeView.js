var storeView = (function() {
    var storeView = {
        ...
        setPage_mySore_1: function() {
            ...
            var wrapper_1 = "<div id='map'>baidumap</div><div class='w-container clearfix'><div class='address-search'>";
            ...
            var wrapper_4 = "</form></div></div><script src='js/lib/sidebarEffects.js'></script>";
            var wrapper = wrapper_1 + wrapper_2 + wrapper_3 + wrapper_4;
            $(".header").html(head);
            $(".container").html(wrapper);

            //点击右上角搜索按钮,显示搜索输入框
            click_Evrnt.click_toogle('#reg', '.address-search');
            // setTimeout("", 100);
            //选中输入框之后,自动开启搜索按钮
            click_Evrnt.input_focus('#search_input', '#search_bt');
            // setTimeout("", 100);
            // page_convert();
        },
        //地图页面跳转至门店搜索结果页面
        setPage_mySore_2: function() {
            ...
            var wrapper_2 = "<li class='next'><a>中国电信(苑平南路营业厅)</a><i class='icon-ic_info_outline_24px'></i></li>";
        ...
        setPage_mySore_3: function() {
            ...
            //营业厅名称
            var wrapper_2 = "<h2 id='js_storeDetailName'>NULL</h2><div class='store_head_img'><img id='js_storeDetailImg' src='' style='width:100%'/></div><ul>";
            //所属区域
            var wrapper_3 = "<li><p>所属区域:</p><span id='js_storeDetailArea'>NULL</span></li>";
            //营业时间
            var wrapper_4 = "<li><p id='js_storeDetailDate'>营业时间:</p><span>NULL</span></li>";
            //昨日销量排名
            var wrapper_5 = "<li><p>昨日销量排名:</p><span id='js_storeDetailNum'>NULL</span></li>";
            //门店状态
            var wrapper_6 = "<li><p>门店状态:</p><span style='background-color: #3498db' class='status'>正常</span></li>";
            //负责人
            var wrapper_7 = "<li><a href='#' class='next button purple'><span id='js_storeDetailManager'>负责人：NULL</span></a></li>";
            //详细地址
            var wrapper_8 = "<li><p class='address'>详细地址:</p><span id='js_storeDetailAddress'>NULL</span></li>";
            //距离你的位置
            var wrapper_9 = "<li><p>距离您当前位置:</p><span>NULL</span></li>";
            //联系电话
            var wrapper_10 = "<li><p>联系电话:</p><span id='js_storeDetailPhone'>NULL</span></li>";
        ...
        setPage_mySore_4: function() {
            ...
            this.pageindex = 4;
            var head = "<button data-effect='st-effect' class='back pageback'><i class='icon-ic_keyboard_arrow_left_24px'></i></button><span id='js_manager'>负责人：</span><a href='#'><i></i></a>";
            ...
            //保持和取消按钮
            var wrapper_6 = "<ul class='control'><li><a class='back button gray'><span>取 消</span></a></li><li><a href='#' class='back button green'><span>保 存</span></a></li></ul>";
